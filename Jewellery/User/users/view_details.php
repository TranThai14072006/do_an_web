...
switch ($order['status']) {
    ...
    case 'Processed':
    case 'Processing': $status_class = 'completed'; $status_text = 'Processing'; break;
    case 'Shipping':
    case 'Shipped':    $status_class = 'completed'; $status_text = 'Shipping'; break;
...
<style>
  * { margin:0; padding:0; box-sizing:border-box; font-family:"Cormorant Garamond", serif; }
  ...
  .alert-success { background: rgba(76,175,80,.12); border: 1px solid #4caf50; color: #2e7d32; }
  .alert-error   { background: rgba(244,67,54,.10); border: 1px solid #f44336; color: #c62828; }
  ...
  .btn-cancel:hover { background: #f44336; color: #fff; transform: scale(1.04); }
  ...
  .modal-box {
    ...
    animation: popIn .25s ease; box-shadow: 0 8px 32px rgba(0,0,0,.18);
  }
  @keyframes popIn { from { opacity:0; transform:scale(.9); } to { opacity:1; transform:scale(1); } }
  .modal-box .modal-icon { font-size: 44px; color: #f44336; margin-bottom: 12px; }
  .modal-box h3 { font-size: 20px; color: #333; margin-bottom: 8px; }
  .modal-box p { font-size: 14px; color: #666; margin-bottom: 22px; line-height: 1.6; }
  .modal-actions { display: flex; gap: 10px; justify-content: center; }
  .btn-modal-back {
    padding: 9px 20px; border-radius: 8px; border: 1.5px solid #ccc;
    background: #f5f5f5; color: #333; font-size: 14px; font-weight: 600;
    cursor: pointer; transition: .2s; font-family: inherit;
  }
  .btn-modal-back:hover { border-color: #999; background: #ebebeb; }
  .btn-modal-confirm {
    padding: 9px 20px; border-radius: 8px; border: none;
    background: #f44336; color: #fff; font-size: 14px; font-weight: 700;
    cursor: pointer; transition: .2s; font-family: inherit;
  }
  .btn-modal-confirm:hover { background: #d32f2f; }

  .total { text-align:right; font-size:18px; font-weight:600; color:#222; margin-top: 16px; }
